...
function renderExamSchedules(){
  ...
  host.querySelectorAll('[data-sync-time-btn]').forEach(button=>button.addEventListener('click',()=>{
    const index=Number(button.dataset.syncTimeBtn);
    const select=host.querySelector(`[data-sync-time-source="${index}"]`);
